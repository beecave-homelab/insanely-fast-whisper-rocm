...
`insanely_fast_whisper_api/utils/srt_quality.py`. The score ranges from 0.0 to
...
python -m insanely_fast_whisper_api.cli transcribe audio.mp3 --debug
```
...
```text
DEBUG:insanely_fast_whisper_api.core.formatters:_result_to_words: examining result with chunks=True, segments=True
DEBUG:insanely_fast_whisper_api.core.formatters:Found 142 potential words from chunks, avg_duration=0.234s
DEBUG:insanely_fast_whisper_api.core.segmentation:segment_words: processing 142 input words
DEBUG:insanely_fast_whisper_api.core.segmentation:After expansion: 145 words
DEBUG:insanely_fast_whisper_api.core.segmentation:Split into 8 sentence chunks
DEBUG:insanely_fast_whisper_api.core.segmentation:Before merge_short_segments: 12 segments
DEBUG:insanely_fast_whisper_api.core.segmentation:After merge_short_segments: 10 segments
DEBUG:insanely_fast_whisper_api.core.segmentation:segment_words returning 10 final segments
```
...
with patch("insanely_fast_whisper_api.utils.constants.MAX_LINE_CHARS", 50):
