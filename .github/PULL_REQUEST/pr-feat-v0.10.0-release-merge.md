...
2.  **`insanely_fast_whisper_rocm/core/asr_backend.py`**
    -   Modified to conditionally apply `stable-ts` stabilization based on the `--stabilize` flag.
3.  **`insanely_fast_whisper_rocm/webui/handlers.py`**
