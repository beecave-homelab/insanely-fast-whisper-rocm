...
def test_convert_to_stable_segments(sample_result):
...
def test_stabilize_returns_original_without_dependency(sample_result):
...
def test_stabilize_success(monkeypatch, sample_result):
    ...
    def fake_transcribe_any(inference_func, *_, **__):  # noqa: D401, D403
        base = inference_func()
