"""Tests for insanely_fast_whisper_rocm.utils.env_loader module.
...
class TestEnvLoaderConstants:
    ...
    def test_project_root__is_valid_path(self) -> None:
        ...
        from insanely_fast_whisper_rocm.utils.env_loader import PROJECT_ROOT
    ...
    def test_project_root_env_file__path_format(self) -> None:
        ...
        from insanely_fast_whisper_rocm.utils.env_loader import PROJECT_ROOT_ENV_FILE
    ...
    def test_user_config_dir__path_format(self) -> None:
        ...
        from insanely_fast_whisper_rocm.utils.env_loader import USER_CONFIG_DIR

        assert isinstance(USER_CONFIG_DIR, Path)
        assert "insanely-fast-whisper-rocm" in str(USER_CONFIG_DIR)

    def test_user_env_file__path_format(self) -> None:
        """Test that USER_ENV_FILE has correct format."""
        from insanely_fast_whisper_rocm.utils.env_loader import USER_ENV_FILE
...
class TestDebugPrint:
    ...
    @patch("insanely_fast_whisper_rocm.utils.env_loader.SHOW_DEBUG_PRINTS", True)
    @patch("insanely_fast_whisper_rocm.utils.env_loader.logger")
    def test_debug_print__prints_when_enabled(self, mock_logger: MagicMock) -> None:
        ...
        from insanely_fast_whisper_rocm.utils.env_loader import debug_print

        debug_print("Test message")

        mock_logger.debug.assert_called_once_with("Test message")

    @patch("insanely_fast_whisper_rocm.utils.env_loader.SHOW_DEBUG_PRINTS", False)
    @patch("insanely_fast_whisper_rocm.utils.env_loader.logger")
...
class TestEnvLoaderBehavior:
    ...
    def test_show_debug_prints__with_cli_flag(self) -> None:
        ...
        from insanely_fast_whisper_rocm.utils.env_loader import SHOW_DEBUG_PRINTS
    ...
    def test_project_root_env_exists__is_boolean(self) -> None:
        ...
        from insanely_fast_whisper_rocm.utils.env_loader import PROJECT_ROOT_ENV_EXISTS
    ...
    def test_user_env_exists__is_boolean(self) -> None:
        ...
        from insanely_fast_whisper_rocm.utils.env_loader import USER_ENV_EXISTS
...
class TestEnvLoaderInitialization:
    ...
    def test_initialization__no_env_files(self) -> None:
        ...
        from insanely_fast_whisper_rocm.utils import env_loader
...
class TestModuleStateFlags:
    ...
    def test_cli_debug_mode__flag_detection(self) -> None:
        ...
        from insanely_fast_whisper_rocm.utils.env_loader import _cli_debug_mode
...
class TestLoggingConfiguration:
    ...
    def test_logger__properly_named(self) -> None:
        ...
        assert env_loader.logger.name == "insanely_fast_whisper_rocm.utils.env_loader"
    ...
    def test_logging_config__debug_mode_enabled(self) -> None:
        ...
        app_logger = logging.getLogger("insanely_fast_whisper_rocm")
